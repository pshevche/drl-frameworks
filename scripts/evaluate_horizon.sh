...
for fullfile in src/horizon/experiments/cartpole/cpu/*.json; do 
    ...
    python src/horizon/run_evaluation.py -p src/horizon/experiments/cartpole/cpu/${experiment}.json -f results/cartpole/${experiment}/checkpoints.json -v results/cartpole/
